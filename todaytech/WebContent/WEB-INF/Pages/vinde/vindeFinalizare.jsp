...
<body>
<div style="width:30%;display: block;margin-left: auto;margin-right: auto;margin-top:30%">
...
<h1 >Telefonul a fost vandut cu succes</h1>
<br>
<form action="${pageContext.request.contextPath}/loginS">
<div id="container" style="margin-top:2%;text-align:center;margin-left:-10%">
